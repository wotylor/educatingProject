      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.suozaichengshi" class="input" type="text" placeholder="所在城市">
			   </div>
			 </div> -->
			<el-form-item label="所在城市" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.suozaichengshi" autocomplete="off" placeholder="所在城市"  />
			</el-form-item>
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='fangdong'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="电话号码" class="input" v-if="tableName=='fangdong'">
			  <el-input v-model="ruleForm.dianhuahaoma" autocomplete="off" placeholder="电话号码"  />
			</el-form-item>
			<!-- <div v-if="tableName=='fangdong'" class="input-group">
			   <div class="label">身份证</div>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.fangdongxingming) && `fangdong` == this.tableName){
      ...
      if(`fangdong` == this.tableName && this.ruleForm.dianhuahaoma&&(!this.$validate.isMobile(this.ruleForm.dianhuahaoma))){
        this.$message.error(`电话号码应输入手机格式`);
        return
      }
