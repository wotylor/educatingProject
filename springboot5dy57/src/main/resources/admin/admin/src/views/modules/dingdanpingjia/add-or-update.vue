    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="评价编号" prop="pingjiabianhao">
            <el-input v-model="ruleForm.pingjiabianhao" 
                placeholder="评价编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pingjiabianhao" label="评价编号" prop="pingjiabianhao">
              <el-input v-model="ruleForm.pingjiabianhao" 
                placeholder="评价编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="评价类型" prop="pingjialeixing">
          <el-select :disabled="ro.pingjialeixing" v-model="ruleForm.pingjialeixing" placeholder="请选择评价类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="评价类型" prop="pingjialeixing">
	      <el-input v-model="ruleForm.pingjialeixing"
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fangjianleixing = true;
          ...
          if(o=='pingjialeixing'){
            this.ruleForm.pingjialeixing = obj[o];
	    this.ro.pingjialeixing = true;
            continue;
          }
          if(o=='pingfen'){
