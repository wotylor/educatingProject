<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="离店时间" prop="lidianshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.lidianshijian" 
                type="datetime"
                :readonly="ro.lidianshijian"
                placeholder="离店时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.lidianshijian" label="离店时间" prop="lidianshijian">
              <el-input v-model="ruleForm.lidianshijian" 
                placeholder="离店时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.huiyuandengji!=''&&json.huiyuandengji){
                this.ruleForm.huiyuandengji = json.huiyuandengji
	    		this.ro.huiyuandengji = true;
		}
		if(json.zhekou!=''&&json.zhekou){
                this.ruleForm.zhekou = json.zhekou
	    		this.ro.zhekou = true;
		}
