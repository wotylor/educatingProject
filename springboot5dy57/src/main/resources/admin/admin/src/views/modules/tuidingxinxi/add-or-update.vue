<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="退订编号" prop="tuidingbianhao">
            <el-input v-model="ruleForm.tuidingbianhao" 
                placeholder="退订编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuidingbianhao" label="退订编号" prop="tuidingbianhao">
              <el-input v-model="ruleForm.tuidingbianhao" 
                placeholder="退订编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="民宿名称" prop="minsumingcheng">
          <el-input v-model="ruleForm.minsumingcheng" 
              placeholder="民宿名称" clearable  :readonly="ro.minsumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="民宿名称" prop="minsumingcheng">
              <el-input v-model="ruleForm.minsumingcheng" 
                placeholder="民宿名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="折扣" prop="zhekou">
          <el-input v-model="ruleForm.zhekou" 
              placeholder="折扣" clearable  :readonly="ro.zhekou"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="折扣" prop="zhekou">
              <el-input v-model="ruleForm.zhekou" 
                placeholder="折扣" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入住天数" prop="ruzhutianshu">
          <el-input v-model="ruleForm.ruzhutianshu" 
              placeholder="入住天数" clearable  :readonly="ro.ruzhutianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入住天数" prop="ruzhutianshu">
              <el-input v-model="ruleForm.ruzhutianshu" 
                placeholder="入住天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="租客人数" prop="zukerenshu">
          <el-input v-model="ruleForm.zukerenshu" 
              placeholder="租客人数" clearable  :readonly="ro.zukerenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="租客人数" prop="zukerenshu">
              <el-input v-model="ruleForm.zukerenshu" 
                placeholder="租客人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="退订时间" prop="tuidingshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.tuidingshijian" 
                type="date"
                :readonly="ro.tuidingshijian"
                placeholder="退订时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tuidingshijian" label="退订时间" prop="tuidingshijian">
              <el-input v-model="ruleForm.tuidingshijian" 
                placeholder="退订时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    ...
    zongjiage:{
      get: function () {
        return 1*this.ruleForm.jiage*this.ruleForm.zhekou*this.ruleForm.ruzhutianshu
      }
    },

  },
  created() {
	this.ruleForm.tuidingshijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='tuidingbianhao'){
            this.ruleForm.tuidingbianhao = obj[o];
	    this.ro.tuidingbianhao = true;
            continue;
          }
          if(o=='minsumingcheng'){
	    ...
	    this.ro.ruzhutianshu = true;
          ...
          if(o=='zukerenshu'){
            this.ruleForm.zukerenshu = obj[o];
	    this.ro.zukerenshu = true;
            continue;
          }
          if(o=='zongjiage'){
	    ...
	    this.ro.zongjiage = true;
          ...
          if(o=='tuidingshijian'){
            this.ruleForm.tuidingshijian = obj[o];
	    this.ro.tuidingshijian = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tuidingxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tuidingxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
