<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所在城市" prop="suozaichengshi">
          <el-input v-model="ruleForm.suozaichengshi" 
              placeholder="所在城市" clearable  :readonly="ro.suozaichengshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所在城市" prop="suozaichengshi">
              <el-input v-model="ruleForm.suozaichengshi" 
                placeholder="所在城市" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
