  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="所在城市" prop="suozaichengshi">
          <el-input v-model="ruleForm.suozaichengshi"               placeholder="所在城市" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='yonghu'" label="会员等级" prop="huiyuandengji">
          <el-select  @change="yonghuhuiyuandengjiChange" :disabled="true" v-model="ruleForm.huiyuandengji" placeholder="请选择会员等级">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="折扣" prop="zhekou">
          <el-input v-model="ruleForm.zhekou" readonly              placeholder="折扣" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='fangdong'"  label="电话号码" prop="dianhuahaoma">
          <el-input v-model="ruleForm.dianhuahaoma"               placeholder="电话号码" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.fangdongxingming)&& 'fangdong'==this.flag){
        this.$message.error('房东姓名不能为空');
        return
      }
      ...
      if( 'fangdong' ==this.flag && this.ruleForm.dianhuahaoma&&(!isMobile(this.ruleForm.dianhuahaoma))){
        this.$message.error(`电话号码应输入手机格式`);
        return
      }
