<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="民宿编号" prop="minsubianhao">
            <el-input v-model="ruleForm.minsubianhao" 
                placeholder="民宿编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.minsubianhao" label="民宿编号" prop="minsubianhao">
              <el-input v-model="ruleForm.minsubianhao" 
                placeholder="民宿编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="民宿星级" prop="minsuxingji">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="房间设施" prop="fangjiansheshi">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fangjiansheshi" label="房间设施" prop="fangjiansheshi">
                    <span>{{ruleForm.fangjiansheshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  data() {
	...
	clicknum : false,
      ...
      rules: {
          ...
          minsuxingji: [
                { required: true, message: '民宿星级不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          fangjiansheshi: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='minsubianhao'){
            this.ruleForm.minsubianhao = obj[o];
	    this.ro.minsubianhao = true;
            continue;
          }
          if(o=='minsumingcheng'){
	...
	this.ruleForm.jiudianjieshao = this.ruleForm.jiudianjieshao.replace(reg,'../../../springboot5dy57/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
