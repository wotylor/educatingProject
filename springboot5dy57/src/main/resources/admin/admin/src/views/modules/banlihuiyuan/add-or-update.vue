<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="办理编号" prop="banlibianhao">
            <el-input v-model="ruleForm.banlibianhao" 
                placeholder="办理编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.banlibianhao" label="办理编号" prop="banlibianhao">
              <el-input v-model="ruleForm.banlibianhao" 
                placeholder="办理编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="民宿名称" prop="minsumingcheng">
          <el-select :disabled="ro.minsumingcheng" v-model="ruleForm.minsumingcheng" placeholder="请选择民宿名称">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="办理费用" prop="banlifeiyong">
          <el-input v-model="ruleForm.banlifeiyong" 
              placeholder="办理费用" clearable  :readonly="ro.banlifeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="办理费用" prop="banlifeiyong">
              <el-input v-model="ruleForm.banlifeiyong" 
                placeholder="办理费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.banlishijian" label="办理时间" prop="banlishijian">
              <el-input v-model="ruleForm.banlishijian" 
                placeholder="办理时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.banlishijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='banlibianhao'){
            this.ruleForm.banlibianhao = obj[o];
	    this.ro.banlibianhao = true;
            continue;
          }
          if(o=='minsumingcheng'){
	    ...
	    this.ro.zhekou = true;
          ...
          if(o=='banlifeiyong'){
            this.ruleForm.banlifeiyong = obj[o];
	    this.ro.banlifeiyong = true;
            continue;
          }
          if(o=='banlishijian'){
    ...
    huiyuandengjiChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              if(data.data.zhekou){
                this.ruleForm.zhekou = data.data.zhekou
              }
              if(data.data.banlifeiyong){
                this.ruleForm.banlifeiyong = data.data.banlifeiyong
              }
        } else {
          this.$message.error(data.msg);
        }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `banlihuiyuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.banlihuiyuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
