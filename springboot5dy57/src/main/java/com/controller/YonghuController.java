...
public class YonghuController {
	...
	/**
	 * 登录
     * selectone是IService接口提供的单条语句查询的方法
	 */
	@IgnoreAuth
...
//                if("否".equals(user.getSfsh())) return R.error("账号未审核，请联系管理员审核。");
     ...
     * 发送邮件
     */
        @IgnoreAuth//用在方法上，忽略权限校验
    @RequestMapping("/sendemail")
    public R sendemail(@RequestParam String email){
//            通过commonUtil工具类提供的getRandomNumber方法获取随机四位的邮箱验证码
                ...
                CommonUtil.sendEmail(email, "有家-Yolca 民宿短租平台用户注册","您的注册验证码是【"+code+"】，请勿将验证码泄漏给其他人。");
        return R.ok();
    }
    ...
    /**
     * 后端列表
     * querypage是YonghuService提供的一个分页方法
     */
    @RequestMapping("/page")
