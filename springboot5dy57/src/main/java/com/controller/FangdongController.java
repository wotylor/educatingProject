...
public class FangdongController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		String token = tokenService.generateToken(user.getId(), username,"fangdong",  "管理员" );
    ...
    public R register(@RequestBody FangdongEntity fangdong){
    	...
    	FangdongEntity user = fangdongService.selectOne(new EntityWrapper<FangdongEntity>().eq("fangdongzhanghao", fangdong.getFangdongzhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        FangdongEntity user = fangdongService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        user.setMima("123456");
        fangdongService.updateById(user);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<FangdongEntity> wrapper = new EntityWrapper<FangdongEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = fangdongService.selectCount(wrapper);
