...
public class YudingxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,YudingxinxiEntity yudingxinxi,
                ...
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date lidianshijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date lidianshijianend,
		...
		if(tableName.equals("fangdong")) {
			yudingxinxi.setFangdongzhanghao((String)request.getSession().getAttribute("username"));
		}
        EntityWrapper<YudingxinxiEntity> ew = new EntityWrapper<YudingxinxiEntity>();
                ...
                if(lidianshijianstart!=null) ew.ge("lidianshijian", lidianshijianstart);
                if(lidianshijianend!=null) ew.le("lidianshijian", lidianshijianend);
