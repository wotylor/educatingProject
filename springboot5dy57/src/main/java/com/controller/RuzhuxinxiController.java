...
public class RuzhuxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,RuzhuxinxiEntity ruzhuxinxi,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date ruzhushijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date ruzhushijianend,
		...
		if(tableName.equals("fangdong")) {
			ruzhuxinxi.setFangdongzhanghao((String)request.getSession().getAttribute("username"));
		}
        EntityWrapper<RuzhuxinxiEntity> ew = new EntityWrapper<RuzhuxinxiEntity>();
                if(ruzhushijianstart!=null) ew.ge("ruzhushijian", ruzhushijianstart);
                if(ruzhushijianend!=null) ew.le("ruzhushijian", ruzhushijianend);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<RuzhuxinxiEntity> wrapper = new EntityWrapper<RuzhuxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = ruzhuxinxiService.selectCount(wrapper);
