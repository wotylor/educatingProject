...
public class BanlihuiyuanController {
    ...
    public R page(@RequestParam Map<String, Object> params,BanlihuiyuanEntity banlihuiyuan,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date banlishijianstart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date banlishijianend,
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			banlihuiyuan.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
